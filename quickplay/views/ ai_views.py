...
class QuestionViewSet(viewsets.ModelViewSet):
    """ViewSet for AI-generated questions with additional actions for generation and retrieval."""
    ...
    def get_random(self, request):
        """Retrieve a random question based on optional category and difficulty filters."""
        try:
